...
namespace Garanti3D_PAY.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Index(garanti3DViewModel Model)
        {
            ...
            string HashData = GetSHA1(strTerminalID + strOrderID + strAmount + strCurrencyCode + strSuccessURL + strErrorURL + strType + strInstallmentCount + strStoreKey + SecurityData).ToUpper();
